...
explicável* utilizando o dataset **[SMS Spam Collection](https://archive.ics.uci.edu/dataset/228/sms+spam+collection)**.
...
### 👉 [Abrir Relatório dos Resultados em PDF 📄](docs/Relatorio_dos_Resultados.pdf)
